...
public class CameraChangeTrigger : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (!followPlayer) cameraFollow.CallChangeCameraModeToStatic(false ,newStaticCamPos.position, newStaticCamPos.rotation, camSpeedOnZoneEntering, aimPlayer);
    ...
    void OnTriggerExit(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            if (!followPlayer) cameraFollow.CallChangeCameraModeToStatic(true ,newStaticCamPos.position, newStaticCamPos.rotation, camSpeedOnZoneExiting, aimPlayer);
